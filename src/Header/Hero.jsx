    ...
    <div className='mt-4'>
      <div style={{
        ...
        <div className="lg:flex lg:flex-row flex flex-col-reverse items-center gap-5 text-[#fff]">
          <div className="max-w-screen-sm pb-5 px-4">
            ...
            <button className="btn bg-base-100 normal-case">Shop Now <FaCartArrowDown/></button>
          </div>
          <div className="my-10 px-4"><img src="https://i.postimg.cc/T2FH1g6g/banner.png" alt="" /></div>
        </div>
      </div>
    </div>
  );
